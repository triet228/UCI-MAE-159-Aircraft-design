...
for i = 1:Weight_takeoff_number_of_steps
    ...
    % C. Hull Insurance
    Weight_airframe = Weight_takeoff - Weight_fuel - Weight_payload - Weight_power_plant;
...
figure;
plot(Weight_takeoff_list, DOC_list, '-o', 'LineWidth', 2, 'MarkerSize', 8);
grid on;
xlabel('Weight Takeoff');
ylabel('Direct Operating Cost (DOC)');
title('Effect of Weight Takeoff on Direct Operating Cost');
legend('DOC vs Weight Takeoff');
